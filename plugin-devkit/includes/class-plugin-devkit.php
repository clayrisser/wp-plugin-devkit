...
class Plugin_Devkit {
	 ...
	 *
	 * Set the plugin devkit and the plugin version that can be used throughout the plugin.
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Plugin_Devkit_Admin( $this->get_plugin_devkit(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Plugin_Devkit_Public( $this->get_plugin_devkit(), $this->get_version() );
